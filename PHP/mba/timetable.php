<html>
   <head>
      <title>Projector Request - MBA</title>
      <style type="text/css">
         table {
   ...
   <?php
      ...
      $sql = "SELECT DISTINCT date FROM `mba.projector` WHERE (date BETWEEN '$today' AND '$thisweek') order by date asc";
      $result = mysqli_query($conn, $sql);
      echo '<h1>Projector Request - MBA</h1>';
      ...
      //if there exists some DATES
      	...
      	$date= $row['date'];
      	$sql_date_fetch = "SELECT * FROM `mba.projector` WHERE date='$date'";
