<html>
   <head>
      <title>Projector Request - ECE</title>
      <style type="text/css">
         table {
   ...
   <?php
      ...
      $sql = "SELECT DISTINCT date FROM `ece.projector` WHERE (date BETWEEN '$today' AND '$thisweek') order by date asc";
      $result = mysqli_query($conn, $sql);
      echo '<h1>Projector Request - ECE</h1>';
      ...
      //if there exists some DATES
      	...
      	$date= $row['date'];
      	$sql_date_fetch = "SELECT * FROM `ece.projector` WHERE date='$date'";
