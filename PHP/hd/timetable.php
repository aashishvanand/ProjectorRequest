<html>
   <head>
      <title>Projector Request - Humanities and Sciences</title>
      <style type="text/css">
         table {
   ...
   <?php
      ...
      $sql = "SELECT DISTINCT date FROM `hd.projector` WHERE (date BETWEEN '$today' AND '$thisweek') order by date asc";
      $result = mysqli_query($conn, $sql);
      echo '<h1>Projector Request - Humanities and Sciences</h1>';
      ...
      //if there exists some DATES
      	...
      	$date= $row['date'];
      	$sql_date_fetch = "SELECT * FROM `hd.projector` WHERE date='$date'";
